...
export default function Footer() {
  return (
    <footer className="footer p-10 bg-beatsflow-black text-beatsflow-light-white">
      <div>
        <Link href="/">
          <h4 className="text-4xl">BEATSFLOW</h4>
        </Link>
        <p>
          © 2023 Beats Flow
          <br />
      ...
      <div>
        ...
        <Link href="/inscription" className="link link-hover">
          Inscription
        </Link>
      </div>
      <div>
